...
const AppNotifications = _i1.OperationDefinitionNode(
...
const UserDeviceRegistration = _i1.OperationDefinitionNode(
  type: _i1.OperationType.mutation,
  name: _i1.NameNode(value: 'UserDeviceRegistration'),
  variableDefinitions: [
    _i1.VariableDefinitionNode(
      variable: _i1.VariableNode(name: _i1.NameNode(value: 'data')),
      type: _i1.NamedTypeNode(
        name: _i1.NameNode(value: 'FirebaseDeviceTokenCreateInput'),
        isNonNull: true,
      ),
  ...
  selectionSet: _i1.SelectionSetNode(selections: [
    _i1.FieldNode(
      name: _i1.NameNode(value: 'createFirebaseDeviceToken'),
      alias: null,
      arguments: [
        _i1.ArgumentNode(
