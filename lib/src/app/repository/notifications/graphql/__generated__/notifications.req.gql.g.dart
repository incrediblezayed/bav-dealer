...
class _$GUserDeviceRegistrationReqSerializer
    implements StructuredSerializer<GUserDeviceRegistrationReq> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  final String wireName = 'GUserDeviceRegistrationReq';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GUserDeviceRegistrationReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GUserDeviceRegistrationVars)),
      'operation',
      serializers.serialize(object.operation,
          specifiedType: const FullType(_i4.Operation)),
      'executeOnListen',
    ...
    if (value != null) {
      result
        ..add('optimisticResponse')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GUserDeviceRegistrationData)));
    }
    value = object.updateCacheHandlerKey;
    if (value != null) {
      result
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'vars':
          result.vars.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(_i3.GUserDeviceRegistrationVars))!
              as _i3.GUserDeviceRegistrationVars);
          break;
        case 'operation':
          result.operation = serializers.deserialize(value,
              specifiedType: const FullType(_i4.Operation))! as _i4.Operation;
        ...
        case 'optimisticResponse':
          result.optimisticResponse.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(_i2.GUserDeviceRegistrationData))!
              as _i2.GUserDeviceRegistrationData);
          break;
        case 'updateCacheHandlerKey':
          result.updateCacheHandlerKey = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
...
class _$GUserDeviceRegistrationReq extends GUserDeviceRegistrationReq {
  @override
  final _i3.GUserDeviceRegistrationVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GUserDeviceRegistrationData? Function(
          _i2.GUserDeviceRegistrationData?, _i2.GUserDeviceRegistrationData?)?
      updateResult;
  @override
  final _i2.GUserDeviceRegistrationData? optimisticResponse;
  @override
  final String? updateCacheHandlerKey;
  @override
  final Map<String, dynamic>? updateCacheHandlerContext;
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    final dynamic _$dynamicOther = other;
    return other is GUserDeviceRegistrationReq &&
        vars == other.vars &&
        operation == other.operation &&
        requestId == other.requestId &&
        updateResult == _$dynamicOther.updateResult &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GUserDeviceRegistrationReq')
          ..add('vars', vars)
          ..add('operation', operation)
          ..add('requestId', requestId)
          ..add('updateResult', updateResult)
...
class GUserDeviceRegistrationReqBuilder
    implements
        Builder<GUserDeviceRegistrationReq, GUserDeviceRegistrationReqBuilder> {
  _$GUserDeviceRegistrationReq? _$v;
  ...
  GUserDeviceRegistrationReqBuilder() {
    GUserDeviceRegistrationReq._initializeBuilder(this);
  }

  GUserDeviceRegistrationReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _vars = $v.vars.toBuilder();
      _operation = $v.operation;
  ...
  @override
  void update(void Function(GUserDeviceRegistrationReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GUserDeviceRegistrationReq build() => _build();

  _$GUserDeviceRegistrationReq _build() {
